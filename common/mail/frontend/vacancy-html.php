                ...
                <tr>
                    <td align="center" class="titleblock" style="padding:7px 0">
                        <font size="2" face="Open-sans, sans-serif" color="#555454">
                            <span class="title" style="font-weight:500;font-size:28px;text-transform:uppercase;line-height:33px">Новое резюме с сайта <?= $site_name ?></span>
                        </font>
                    </td>
                </tr>
                <tr>
                                ...
                                <td style="padding:7px 0">
                                    <font size="2" face="Open-sans, sans-serif" color="#555454">
                                        ...
                                        <?php if($data['instagram']): ?>
                                            <p data-html-only="1" style="border-bottom:1px solid #D6D4D4;margin:3px 0 7px;font-weight:500;font-size:18px;padding-bottom:10px">
                                                Instagram: <a href="</a><?= $data['instagram'] ?>">Ссылка</a>
                                            </p>
                                        <?php endif; ?>
                                        <?php if($data['facebook']): ?>
                                            <p data-html-only="1" style="border-bottom:1px solid #D6D4D4;margin:3px 0 7px;font-weight:500;font-size:18px;padding-bottom:10px">
                                                Facebook: <a href="<?= $data['facebook'] ?>">Ссылка</a>
                                            </p>
                                        <?php endif; ?>
                                        <?php if($data['message']): ?>
                                            <p data-html-only="1" style="border-bottom:1px solid #D6D4D4;margin:3px 0 7px;font-weight:500;font-size:18px;padding-bottom:10px">
